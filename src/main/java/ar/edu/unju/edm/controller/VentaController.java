...
public class VentaController {
	...
	public String editarClienteCompra(Model model, @PathVariable(name="codigo") int cod) throws Exception {
		Venta venta = new Venta();		
		try {
			productoSeleccionado = productoService.encontrarUnProducto(cod);
